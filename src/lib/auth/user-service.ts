...
export async function getOrCreateUser(
    ...
    return withRlsBypass(async () => {
        ...
        console.log(`[UserService] Created user ${email} with role ${role} in tenant ${tenant.slug}`);
 ...
 */
export async function updateUserLastOnline(supertokensUserId: string): Promise<void> {
