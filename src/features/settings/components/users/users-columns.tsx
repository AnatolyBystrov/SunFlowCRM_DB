                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuSub>
                                ...
                                <DropdownMenuSubContent>
                                    <DropdownMenuRadioGroup
                                        value={user.role}
                                        onValueChange={(val) => onUpdateRole(user.id, val as UserRole)}
                                    >
                            ...
                            <DropdownMenuSub>
                                ...
                                <DropdownMenuSubContent>
                                    <DropdownMenuRadioGroup
                                        value={user.status}
                                        onValueChange={(val) => onUpdateStatus(user.id, val as UserStatus)}
                                    >
                                        <DropdownMenuRadioItem value="ACTIVE">Activate</DropdownMenuRadioItem>
                                        <DropdownMenuRadioItem value="INACTIVE">Disable</DropdownMenuRadioItem>
                                    </DropdownMenuRadioGroup>
                                </DropdownMenuSubContent>
                            </DropdownMenuSub>

                            {user.status === 'INVITED' && (
                                <DropdownMenuItem onClick={() => { /* Invite logic usually just creates, but here we could re-trigger */ }}>
                                    Resend Invite
                                </DropdownMenuItem>
                            )}
                        </DropdownMenuContent>
