...
const authSettingsSchema = z.object({
    ...
    sessionLifetimeMinutes: z.coerce.number().min(15),
});
...
export function AuthSettingsForm() {
    ...
    if (isLoading) {
        return <div className="space-y-4">
            <div className="h-64 w-full animate-pulse bg-muted/20 rounded-md" />
            <div className="h-64 w-full animate-pulse bg-muted/20 rounded-md" />
        </div>;
    }
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Control how users can sign up and log in to your organization.</CardDescription>
                    </CardHeader>
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                    <div className="space-y-0.5">
                                        <FormLabel className="text-base">Invite-only Registration</FormLabel>
                                        <FormDescription>
                                            If enabled, new users can only join via invitation. Self-signup will be disabled.
                                        </FormDescription>
                                    </div>
                                    <FormControl>
                                        <Switch
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4 opacity-70">
                                    <div className="space-y-0.5">
                                        <FormLabel className="text-base">Social Login (Google, GitHub)</FormLabel>
                                        <FormDescription>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Configure password and session security requirements.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <FormField
                            control={form.control}
                ...
                <Card className="opacity-60 bg-muted/50 border-dashed">
                    ...
                    <CardContent>
                        <div className="flex items-center justify-between p-2">
                            <span className="text-sm">MFA enforcement is currently unavailable.</span>
                            <Button variant="outline" size="sm" disabled>Coming in v2.0</Button>
                        </div>
                    </CardContent>
                </Card>
